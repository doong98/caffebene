$(function(){
    ...
    if(win_width>1024){
        ...
        $('#fullpage').fullpage({            
            ...
            navigationTooltips: ['Main', 'Franchise','Menu','Membership','Benecat','Coffee beans','Event','Store'],
        ...
        if(win_width >= 1600){
          ...
          posx=['40%','8%','8%','40%','74%','74%'];
          posy=['0%','20%','52%','76%','52%','20%'];
        //윈도우의 가로길이가 1200~1599  
        }else if(win_width >= 1200){
          //각 .contents의 가로위치,세로위치값을 배열에 저장
          posx=['40%','8%','8%','40%','74%','74%'];
          posy=['-10%','20%','52%','76%','52%','20%'];
